...
exports.showAllCategories = async (req, res) => {
    try {
        ...
        return res.status(501).json({
            success: false,
            message: "error in fetchind categories"
        });    
    }
};
...
exports.categoryPageDetails = async (req, res) => {
    try {
        ...
        let differentCategoryDetails = await Category.findOne(differentCategoriesId[getRandomInt(differentCategoriesId.length)]._id)
                                                                                                                    .populate({
                                                                                                                        path: "courses",
                                                                                                                        match: {status: "Published"},
                                                                                                                    })
